...
|---|---|---|
| `ts/` | @voxgig-sdk/temporary-email-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/temporary-email-sdk \
      --repository voxgig-sdk/temporary-email-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/temporary-email-sdk` shows it, and
`npm trust revoke @voxgig-sdk/temporary-email-sdk --id=<id>` removes it.
