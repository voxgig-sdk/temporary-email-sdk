...
// TemporaryEmail SDK utility type

class TemporaryEmailUtility
{
    ...
    public static function copy(TemporaryEmailUtility $src): TemporaryEmailUtility
    {
        $u = new TemporaryEmailUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
