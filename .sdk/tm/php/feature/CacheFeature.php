...
// TemporaryEmail SDK cache feature
...
class TemporaryEmailCacheFeature extends TemporaryEmailBaseFeature
{
    ...
    private function _through(TemporaryEmailContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
