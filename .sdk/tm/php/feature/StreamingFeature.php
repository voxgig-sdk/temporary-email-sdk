...
// TemporaryEmail SDK streaming feature
...
class TemporaryEmailStreamingFeature extends TemporaryEmailBaseFeature
{
    ...
    private function _iterate(TemporaryEmailResult $result): \Generator
    {
    ...
    private function _streamable(TemporaryEmailContext $ctx): bool
    {
