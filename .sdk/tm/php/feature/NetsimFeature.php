...
// TemporaryEmail SDK netsim feature
...
class TemporaryEmailNetsimFeature extends TemporaryEmailBaseFeature
{
    ...
    private function _simulate(TemporaryEmailContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(TemporaryEmailContext $ctx, array $applied): void
    {
        $client = $this->client;
