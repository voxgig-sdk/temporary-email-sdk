...
// TemporaryEmail SDK idempotency feature
...
class TemporaryEmailIdempotencyFeature extends TemporaryEmailBaseFeature
{
    ...
    private function _mutating(TemporaryEmailContext $ctx): bool
    {
