...
The Lua SDK for the TemporaryEmail API. Provides an entity-oriented interface using Lua conventions.
...
```lua
local result, err = client:Email(nil):load({ id = "example_id" }, nil)
