...
// TemporaryEmail SDK utility: graphql
//
...
class TemporaryEmailGraphql
{
    ...
    // equivalent.
    public static function body(TemporaryEmailContext $ctx): mixed
    {
    ...
    public static function errors(TemporaryEmailContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
