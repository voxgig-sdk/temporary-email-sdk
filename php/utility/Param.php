...
// TemporaryEmail SDK utility: param

require_once __DIR__ . '/../core/Helpers.php';

class TemporaryEmailParam
{
    public static function call(TemporaryEmailContext $ctx, mixed $paramdef): mixed
    {
        $point = $ctx->point;
        $spec = $ctx->spec;
        $match_val = $ctx->match;
        ...
        $akey = '';
        if ($point) {
            $alias_map = TemporaryEmailHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'alias'));
            if ($alias_map) {
