...
// TemporaryEmail SDK utility: fetcher

class TemporaryEmailFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TemporaryEmailSDK/1.0)';
    ...
    public static function call(TemporaryEmailContext $ctx, string $fullurl, array $fetchdef): array
    {
