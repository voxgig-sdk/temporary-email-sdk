...
// TemporaryEmail SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class TemporaryEmailMakeRequest
{
    public static function call(TemporaryEmailContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new TemporaryEmailResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new TemporaryEmailResponse($fetched);
        } else {
