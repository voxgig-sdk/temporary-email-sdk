# TemporaryEmail PHP SDK

The PHP SDK for the TemporaryEmail API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Email(null)->load(["id" => "example_id"], null);
...
```
php/
├── temporaryemail_sdk.php          -- Main SDK class
...
The main class (`temporaryemail_sdk.php`) exports the SDK class
