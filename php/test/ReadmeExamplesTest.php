...
// TemporaryEmail SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TemporaryEmailSDK::test)
...
{
    private const SDK_CLASS = 'TemporaryEmailSDK';
    ...
    private const SDK_BASE = 'temporaryemail_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../temporaryemail_sdk.php';
