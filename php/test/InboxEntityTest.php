...
class InboxEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set TEMPORARY_EMAIL_TEST_INBOX_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function inbox_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("TEMPORARY_EMAIL_TEST_INBOX_ENTID");
