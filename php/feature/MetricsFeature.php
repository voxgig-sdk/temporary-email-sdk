...
// TemporaryEmail SDK metrics feature
...
class TemporaryEmailMetricsFeature extends TemporaryEmailBaseFeature
{
    ...
    private function _record(TemporaryEmailContext $ctx, bool $ok): void
    {
