...
// TemporaryEmail SDK proxy feature
...
class TemporaryEmailProxyFeature extends TemporaryEmailBaseFeature
{
    ...
    public function init(TemporaryEmailContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (TemporaryEmailContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
