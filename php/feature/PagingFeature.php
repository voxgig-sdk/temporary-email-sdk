...
// TemporaryEmail SDK paging feature
...
class TemporaryEmailPagingFeature extends TemporaryEmailBaseFeature
{
    ...
    private function _is_list(TemporaryEmailContext $ctx): bool
    {
