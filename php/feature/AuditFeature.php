...
// TemporaryEmail SDK audit feature
...
class TemporaryEmailAuditFeature extends TemporaryEmailBaseFeature
{
    ...
    private function _emit(TemporaryEmailContext $ctx, string $outcome): void
    {
