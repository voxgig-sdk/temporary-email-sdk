...
// TemporaryEmail SDK rbac feature
...
class TemporaryEmailRbacFeature extends TemporaryEmailBaseFeature
{
    ...
    private function _required(TemporaryEmailContext $ctx): ?string
    {
    ...
    private function _reject(TemporaryEmailContext $ctx, string $required): void
    {
    ...
    private function _track(TemporaryEmailContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
