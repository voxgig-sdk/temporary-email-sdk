...
// TemporaryEmail SDK clienttrack feature
...
class TemporaryEmailClienttrackFeature extends TemporaryEmailBaseFeature
{
    ...
    public function PostConstruct(TemporaryEmailContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'TemporaryEmail-SDK';
