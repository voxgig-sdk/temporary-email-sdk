...
// TemporaryEmail SDK ratelimit feature
...
class TemporaryEmailRatelimitFeature extends TemporaryEmailBaseFeature
{
    ...
    private function _acquire(TemporaryEmailContext $ctx): void
    {
    ...
    private function _track(TemporaryEmailContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
