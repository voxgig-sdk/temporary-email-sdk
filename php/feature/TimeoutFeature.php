...
// TemporaryEmail SDK timeout feature
...
class TemporaryEmailTimeoutFeature extends TemporaryEmailBaseFeature
{
    ...
    private function _with_timeout(TemporaryEmailContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TemporaryEmailContext $_ctx, float $ms): void
    {
        $client = $this->client;
