...
// TemporaryEmail SDK telemetry feature
...
class TemporaryEmailTelemetryFeature extends TemporaryEmailBaseFeature
{
    ...
    private function _close(TemporaryEmailContext $ctx, bool $ok): void
    {
