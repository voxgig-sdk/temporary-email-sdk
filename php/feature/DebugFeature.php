...
// TemporaryEmail SDK debug feature
...
class TemporaryEmailDebugFeature extends TemporaryEmailBaseFeature
{
    ...
    private function _finish(TemporaryEmailContext $ctx, bool $ok): void
    {
