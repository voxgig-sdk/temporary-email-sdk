...
func registerSDKWords(r *eng.Registry, client *sdk.TemporaryEmailSDK) {
...
func runOp(client *sdk.TemporaryEmailSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
