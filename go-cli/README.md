...
AQL-driven CLI and REPL for the TemporaryEmail SDK. Positional arguments are
...
```sh
go build -o temporary-email-cli ./...
```
...
./temporary-email-cli list email
./temporary-email-cli load 1 email
./temporary-email-cli load '{id:1}' email
