...
func TestInboxEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set TEMPORARYEMAIL_TEST_INBOX_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func inboxBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("TEMPORARYEMAIL_TEST_INBOX_ENTID")
	...
	idmapResolved := core.ToMapAny(env["TEMPORARYEMAIL_TEST_INBOX_ENTID"])
