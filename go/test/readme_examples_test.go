...
const testSeed = `map[string]any{"entity": map[string]any{"email": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "inbox": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "message": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
