# TemporaryEmail SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TemporaryEmailSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TemporaryEmailSDK(...) and TemporaryEmailSDK.test(...) become
#      TemporaryEmailSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "temporaryemail_sdk"
_SDK_CLASS = "TemporaryEmailSDK"
