...
from temporaryemail_sdk.utility import register

# Load features
from temporaryemail_sdk.feature.base_feature import TemporaryEmailBaseFeature
from temporaryemail_sdk.features import _has_feature, _make_feature
...
class TemporaryEmailSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = TemporaryEmailUtility()
        self._utility = utility

        from temporaryemail_sdk.config import shared_config
    ...
    def get_utility(self):
        return TemporaryEmailUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("TemporaryEmailSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Email(self, data=None) -> "EmailEntity":
        ...
        from temporaryemail_sdk.entity.email_entity import EmailEntity
        return EmailEntity(self, data)


    def Inbox(self, data=None) -> "InboxEntity":
        """Entity factory: client.Inbox().list() / client.Inbox().load({"id": ...})."""
        from temporaryemail_sdk.entity.inbox_entity import InboxEntity
    ...
    def Message(self, data=None) -> "MessageEntity":
        ...
        from temporaryemail_sdk.entity.message_entity import MessageEntity
