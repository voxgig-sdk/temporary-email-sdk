...
The Python SDK for the TemporaryEmail API. Provides an entity-oriented interface following Pythonic conventions.
...
```python
result, err = client.Email(None).load({"id": "example_id"}, None)
if err:
    raise Exception(err)
print(result)
```
