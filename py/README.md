# TemporaryEmail Python SDK



The Python SDK for the TemporaryEmail API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Email()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/temporary-email-sdk/releases)) or
...
```
py/
├── temporaryemail_sdk.py         -- Main SDK module
