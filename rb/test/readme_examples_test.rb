...
#      offline in seeded test mode (TemporaryEmailSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "TemporaryEmail_sdk.rb")
  SDK_CLASS = "TemporaryEmailSDK"
