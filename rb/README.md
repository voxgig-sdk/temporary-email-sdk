...
The Ruby SDK for the TemporaryEmail API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
```ruby
result, err = client.Email(nil).load({ "id" => "example_id" }, nil)
raise err if err
puts result
```
