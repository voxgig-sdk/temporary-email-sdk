...
function envOverride(m) {
    if ('TRUE' === process.env.TEMPORARY_EMAIL_TEST_LIVE ||
        'TRUE' === process.env.TEMPORARY_EMAIL_TEST_OVERRIDE) {
    ...
    m.TEMPORARY_EMAIL_TEST_EXPLAIN = process.env.TEMPORARY_EMAIL_TEST_EXPLAIN || m.TEMPORARY_EMAIL_TEST_EXPLAIN;
    return m;
}
