...
(0, node_test_1.describe)('InboxEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set TEMPORARY_EMAIL_TEST_INBOX_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['TEMPORARY_EMAIL_TEST_INBOX_ENTID'];
    ...
    idmap = env['TEMPORARY_EMAIL_TEST_INBOX_ENTID'];
