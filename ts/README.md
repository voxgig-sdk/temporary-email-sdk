# TemporaryEmail TypeScript SDK



The TypeScript SDK for the TemporaryEmail API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Email()` — each with a small set of operations (`load`)
...
| `tester(testopts?, sdkopts?)` | `TemporaryEmailSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `TemporaryEmailSDK.test(testopts?, sdkopts?)` | `TemporaryEmailSDK` | Create a test-mode client. |
...
| `client` | `client(): TemporaryEmailSDK` | Return the parent SDK client. |
...
temporary-email/
├── src/
│   ├── TemporaryEmailSDK.ts        # Main SDK class
