...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.TEMPORARYEMAIL_TEST_LIVE ||
    'TRUE' === process.env.TEMPORARYEMAIL_TEST_OVERRIDE
  ) {
  ...
  m.TEMPORARYEMAIL_TEST_EXPLAIN = process.env.TEMPORARYEMAIL_TEST_EXPLAIN || m.TEMPORARYEMAIL_TEST_EXPLAIN
