// Command TemporaryEmail-mcp is an MCP server exposing the TemporaryEmail
// SDK as MCP tools.
//
// Two tools are registered:
//
//	TemporaryEmail_list  — list records of an entity
//	TemporaryEmail_load  — load a single record of an entity
//
